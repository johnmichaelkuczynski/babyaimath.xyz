    ...
    >
      <AnimatePresence mode="wait">
        {phase < 2 ? (
          ...
          >
            <h1 className="text-4xl font-serif text-primary mb-8 tracking-tight">Baby AI Math</h1>
              ...
              <div className="col-span-2">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <h4 className="font-serif text-lg mb-2">The Math Behind the Machine</h4>
          ...
          >
            ...
            <h1 className="text-4xl font-serif text-primary mb-8 tracking-tight">Unit 1 — The Math Behind the Machine</h1>
              ...
              <div className="divide-y divide-border">
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <span className="font-medium">1.1 Why AI is really math</span>
                  </div>
                ...
                <div className="px-6 py-4 flex items-center justify-between opacity-80">
                  <div className="flex items-center space-x-4">
                    ...
                    <span>1.2 Vectors and embeddings</span>
                  </div>
                ...
                <div className="px-6 py-4 flex items-center justify-between opacity-80">
                  <div className="flex items-center space-x-4">
                    ...
                    <span>1.3 The dot product and distance</span>
                  </div>
                ...
                <div className="px-6 py-4 flex items-center justify-between opacity-80">
                  <div className="flex items-center space-x-4">
                    ...
                    <span>1.5 Slopes and gradients</span>
                  </div>

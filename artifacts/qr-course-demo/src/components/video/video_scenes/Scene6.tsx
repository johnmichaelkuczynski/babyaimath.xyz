        ...
        {phase >= 2 && phase < 5 ? (
            ...
            <div className="space-y-4">
              ...
              >
                <div>
                  ...
                  <h4 className="font-serif text-lg text-primary mb-1">Homework 1.1 — Why AI is really math</h4>
              ...
              >
                <div>
                  <div className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest mb-1">Homework</div>
                  <h4 className="font-serif text-lg text-primary mb-1">Homework 1.2 — Vectors and embeddings</h4>
          ...
          >
            ...
            <div className="bg-white border border-border rounded-xl shadow-sm p-8 mb-6 relative overflow-hidden">
              ...
              <h3 className="font-medium text-lg mb-6 max-w-2xl text-foreground">Q1. Why is a chatbot's reply really just numbers and arithmetic, not magic?</h3>
              
              <div className="mb-6 max-w-2xl">
                <div className="text-xs text-muted-foreground mb-2">Your answer:</div>
                <div className="px-6 py-3 bg-muted/30 border border-border rounded-lg text-base">Because a computer can only do arithmetic, so words are turned into numbers and the model crunches them at a huge scale — the smart-sounding reply is just math, not understanding.</div>
              </div>
                ...
                {phase >= 6 && (
                  ...
                  >
                    ...
                    <div className="text-sm text-blue-900 leading-relaxed">
                      <StreamingText text="Correct. The key idea is that everything a model does reduces to numbers and arithmetic at scale — there's no magic underneath. Clear and well stated." delay={0} />
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>
            ...
            <div className="bg-white border border-border rounded-xl shadow-sm p-8 opacity-50">
              <h3 className="font-medium text-lg mb-6 max-w-2xl text-foreground">Q2. How does turning words into numbers let a model work with language...</h3>

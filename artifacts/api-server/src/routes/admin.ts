...
const GENERATION_SYSTEM = [
  "You generate a test bench of candidate STUDENT answers so an administrator can audit how a functional-intelligence (reasoning-test skills) grader scores them.",

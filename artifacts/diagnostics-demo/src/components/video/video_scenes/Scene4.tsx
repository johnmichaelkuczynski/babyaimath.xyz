  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="text-[3vw] font-display text-white tracking-widest uppercase mb-2">Baby AI Math</h1>
        <p className="text-[1.2vw] text-[var(--color-accent)] italic font-display text-2xl tracking-widest">The math behind the machine.</p>
      </motion.div>
    </motion.div>
  );
}